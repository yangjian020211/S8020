...
{
    NVIC_DisableIRQ(RTC_INTR_VECTOR_NUM);
...
void RTC_enable(void)
{
    ...
    NVIC_SetPriority(RTC_INTR_VECTOR_NUM, NVIC_EncodePriority(u32_priorityGroup, INTR_NVIC_PRIORITY_RTC, 0));
    ...
    NVIC_EnableIRQ(RTC_INTR_VECTOR_NUM);
...
void RTC_INIT(void)
{
    ...
    {        
        STRU_RTC_CALENDAR *pst_rtcCalendar = (STRU_RTC_CALENDAR *)malloc_safe(sizeof(STRU_RTC_CALENDAR) * sizeof(uint8_t));
