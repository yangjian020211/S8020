...
static void ADV_7611_I2CInitial(void)
{
    ...
    if (i2c_initialized == 0)
    {
        ...
        NVIC_SetPriority(I2C_INTR2_VECTOR_NUM,NVIC_EncodePriority(NVIC_PRIORITYGROUP_5,INTR_NVIC_PRIORITY_I2C_DEFAULT,0));
        NVIC_EnableIRQ(I2C_INTR2_VECTOR_NUM);
...
{
    hdmi_edid_table =  CFGBIN_GetNodeData((STRU_cfgBin *)SRAM_CONFIGURE_MEMORY_ST_ADDR, HDMI_EDID_CFG_ID);
