    ...
    .st_factorySetting =
    {
        ...
        .st_band0_rcChData = 
        {
            ...
            .u16_rfChFrqList            =  {2405, 2407, 2409, 2411, 2413, 2415, 2417, 2419, 2421,
                                            ...
                                            2441, 2443, 2445, 2447, 2449, 2451, 2453, 2455, 2459,
                                            2461, 2463, 2465, 2467, 2469, 2471, 2473, 2475, 2477},
        },
        ...
        .st_powerClose_vtData = 
        {
            ...
            .st_2g_chPowerClose = { {.u8_centralGain=0x1a,.u16_regPwr=0x0000,.real_power=200},  //0dbm
                                    ...
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x0400,.real_power=200},  //2
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x0800,.real_power=200},  //3
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x0C00,.real_power=200},  //4
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1000,.real_power=200},  //5
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1400,.real_power=200},  //6
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1800,.real_power=200},  //7
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1C00,.real_power=200},  //8
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2000,.real_power=200},  //9
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2400,.real_power=200},  //10
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2700,.real_power=200},  //11
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2900,.real_power=200},  //12
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2C00,.real_power=200},  //13
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3000,.real_power=200},  //14
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3400,.real_power=150},  //15
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3800,.real_power=158},  //16
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3F00,.real_power=200},  //17
                                    ...
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x5F00,.real_power=200},  //22
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6E00,.real_power=200},  //23
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x8300,.real_power=200},  //24
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x9F00,.real_power=200},  //25
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x7400,.real_power=200},  //26
        ...
        .st_powerClose_rcData = 
        {
            ...
            .st_2g_chPowerClose = { {.u8_centralGain=0x1a,.u16_regPwr=0x0000,.real_power=200},  //0dbm
                                    ...
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1600,.real_power=200},  //7
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1a00,.real_power=200},  //8
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1d00,.real_power=200},  //9
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2000,.real_power=200},  //10
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2200,.real_power=200},  //11
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2400,.real_power=200},  //12
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2600,.real_power=200},  //13
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2800,.real_power=200},  //14
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2c00,.real_power=150},  //15
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2e00,.real_power=158},  //16
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2f00,.real_power=200},  //17
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3400,.real_power=200},  //18
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3b00,.real_power=200},  //19
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x3f00,.real_power=200},  //20
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x4400,.real_power=200},  //21
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x4f00,.real_power=200},  //22
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x5b00,.real_power=200},  //23
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6700,.real_power=200},  //24
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x7400,.real_power=200},  //25
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x9f00,.real_power=200},  //26
                                    {.u8_centralGain=0x0a,.u16_regPwr=0xaf00,.real_power=200},  //27
                                    {.u8_centralGain=0x0a,.u16_regPwr=0xff00,.real_power=200},  //28
                                    {.u8_centralGain=0x0a,.u16_regPwr=0xff00,.real_power=200},  //29
                                    {.u8_centralGain=0x0a,.u16_regPwr=0xff00,.real_power=200}  ///30
                                    },
