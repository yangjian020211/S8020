...
STRU_BB_RC_CH_SELECTION RF8003s_rc_selection =
{
    ...
    .u8_rcChReplaceMaxCnt   = 15,            //suggest no more than 1/2 * (RC channel)
...
STRU_FACTORY_SETTING st_Factory_EK_2t2r_cfg __attribute__ ((aligned (4)))= 
{
    ...
    .st_factorySetting =
    {
        ...
        {
            .u32_rfChCount              = 18,
            .u16_rfChFrqList            = {2405, 2427, 2409, 2431, 2413, 2435, 2417, 2439, 2421, 2443,
                                           2425, 2407, 2429, 2411, 2433, 2415, 2437, 2459, 2441, 2463,
                                           2445, 2467, 2449, 2471, 2453, 2475, 2457, 2419, 2461, 2423,
                                           2465, 2447, 2469, 2451, 2473, 2455},
        },
