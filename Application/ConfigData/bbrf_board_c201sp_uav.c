    ...
    .st_factorySetting =
    {
        ...
        .st_band0_rcChData = 
        {
			...
			/*.u16_rfChFrqList            = {2405, 2407, 2409, 2411, 2413, 2415, 2417, 2419, 2421,
                                            ...
                                            2441, 2443, 2445, 2447, 2449, 2451, 2453, 2455, 2457,
                                            2459, 2461, 2463, 2465, 2467, 2469, 2471, 2473, 2475},*/
        ...
        {
            .u16_2g_ref_frq     = 2406,
            .st_2g_chPowerClose = { {.u8_centralGain=0x1c,.u16_regPwr=0x2100,.real_power=200},  //0dbm
                                    {.u8_centralGain=0x1c,.u16_regPwr=0x2200,.real_power=200},  //1
                                    {.u8_centralGain=0x1c,.u16_regPwr=0x2300,.real_power=200},  //2
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2400,.real_power=200},  //3
                                    {.u8_centralGain=0x19,.u16_regPwr=0x2500,.real_power=200},  //4
                                    {.u8_centralGain=0x18,.u16_regPwr=0x2600,.real_power=200},  //5
                                    {.u8_centralGain=0x18,.u16_regPwr=0x2700,.real_power=200},  //6
                                    {.u8_centralGain=0x17,.u16_regPwr=0x2700,.real_power=200},  //7
                                    {.u8_centralGain=0x16,.u16_regPwr=0x2800,.real_power=200},  //8
                                    {.u8_centralGain=0x15,.u16_regPwr=0x2900,.real_power=200},  //9
                                    {.u8_centralGain=0x14,.u16_regPwr=0x2a00,.real_power=200},  //10
                                    {.u8_centralGain=0x13,.u16_regPwr=0x2b00,.real_power=200},  //11
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2c00,.real_power=200},  //12
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2d00,.real_power=200},  //13
                                    {.u8_centralGain=0x11,.u16_regPwr=0x2f00,.real_power=200},  //14
                                    {.u8_centralGain=0x10,.u16_regPwr=0x3200,.real_power=150},  //15
                                    {.u8_centralGain=0x0f,.u16_regPwr=0x3500,.real_power=158},  //16
                                    {.u8_centralGain=0x0e,.u16_regPwr=0x3800,.real_power=200},  //17
                                    {.u8_centralGain=0x0d,.u16_regPwr=0x3c00,.real_power=200},  //18
                                    {.u8_centralGain=0x0c,.u16_regPwr=0x3d00,.real_power=200},  //19
                                    {.u8_centralGain=0x0b,.u16_regPwr=0x3f00,.real_power=200},  //20
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x4600,.real_power=200},  //21
                                    {.u8_centralGain=0x09,.u16_regPwr=0x4a00,.real_power=200},  //22
                                    {.u8_centralGain=0x08,.u16_regPwr=0x4e00,.real_power=200},  //23
                                    {.u8_centralGain=0x07,.u16_regPwr=0x5500,.real_power=200},  //24
                                    {.u8_centralGain=0x06,.u16_regPwr=0x5b00,.real_power=200},  //25
                                    {.u8_centralGain=0x05,.u16_regPwr=0x6400,.real_power=200},  //26
                                    {.u8_centralGain=0x04,.u16_regPwr=0x6c00,.real_power=200},  //27
                                    {.u8_centralGain=0x04,.u16_regPwr=0x6c00,.real_power=200},  //28
                                    {.u8_centralGain=0x04,.u16_regPwr=0x6c00,.real_power=200},  //29
                                    {.u8_centralGain=0x04,.u16_regPwr=0x6c00,.real_power=200}   //30
                                    },
        },
        ...
        {
            .u16_2g_ref_frq = 2405,
            .st_2g_chPowerClose = { {.u8_centralGain=0x1a,.u16_regPwr=0x1900,.real_power=200},  //0dbm
                                    ...
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1e00,.real_power=200},  //5
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1f00,.real_power=200},  //6
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2000,.real_power=200},  //7
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2100,.real_power=200},  //8
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2200,.real_power=200},  //9
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2300,.real_power=200},  //10
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2400,.real_power=200},  //11
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2500,.real_power=200},  //12
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2700,.real_power=200},  //13
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2900,.real_power=200},  //14
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2b00,.real_power=150},  //15
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x2d00,.real_power=158},  //16
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x3000,.real_power=200},  //17
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x3400,.real_power=200},  //18
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x3800,.real_power=200},  //19
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x3c00,.real_power=200},  //20
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x3f00,.real_power=200},  //21
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x4300,.real_power=200},  //22
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x4800,.real_power=200},  //23
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x5100,.real_power=200},  //24
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x5A00,.real_power=200},  //25
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6000,.real_power=200},  //26
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6700,.real_power=200},  //27
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6700,.real_power=200},  //28
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6700,.real_power=200},  //29
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6700,.real_power=200}  ///30
                                    },
        },
