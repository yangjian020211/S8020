...
extern STRU_BB_REG stru_TEST8003_bb_reg[10];
...
STRU_BB_REG stru_TEST8003_bb_reg[10] __attribute__ ((aligned (4)))= 
{
    {1, 0x09, 0x85},
    {1, 0x0a, 0x85},
    {2, 0x21, 0x20},
...
extern STRU_RF_REG TEST8003_rf_boardReg[5];
...
STRU_RF_REG TEST8003_rf_boardReg[5] __attribute__ ((aligned (4)))=
{
    //pstru_rf1SkyRegs
