...
extern STRU_BB_REG stru_EK_2t2r_bb_reg[5];
...
STRU_BB_REG stru_EK_2t2r_bb_reg[5] __attribute__ ((aligned (4)))= 
{
...
{
    .u8_band0SweepChannelCnt = 40,
    .u16_band0SweepFrq       = {2403, 2405, 2407, 2409, 2411, 2413, 2415, 2417, 2419, 2421,
    ...
    .u16_band1SweepFrq       = {5731, 5733, 5735, 5737, 5739, 5741, 5743, 5745, 5747, 5749,
...
STRU_FACTORY_SETTING st_Factory_EK_2t2r_cfg __attribute__ ((aligned (4)))= 
{
    ...
    .st_factorySetting =
    {
        ...
        {
            .u32_rfChCount              = 40,
            .u16_rfChFrqList            = {5731, 5733, 5735, 5737, 5739, 5741, 5743, 5745, 5747, 5749,
                                           5751, 5753, 5755, 5757, 5759, 5761, 5763, 5765, 5767, 5769,
                                           5771, 5773, 5775, 5777, 5779, 5781, 5783, 5785, 5787, 5789, 
                                           5791, 5793, 5795, 5797, 5799, 5801, 5803, 5805, 5807, 5809,
                                           5811, 5813, 5815, 5817, 5819, 5821, 5823, 5825, 5827, 5829},
        ...
        {
            .u32_rfChCount              = 20,
            .u16_rfChFrqList            = {5740, 5745, 5750, 5755, 5760, 5765, 5770, 5775, 5780, 5785,
        ...
        {
            .u16_2g_ref_frq     = 2406,
            .st_2g_chPowerClose = { {.u8_centralGain=0x1a,.u16_regPwr=0x1e00,.real_power=200},  //0dbm
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2100,.real_power=200},  //1
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2400,.real_power=200},  //2
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2700,.real_power=200},  //3
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2a00,.real_power=200},  //4
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2a00,.real_power=200},  //5
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2e00,.real_power=200},  //6
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3200,.real_power=200},  //7
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3600,.real_power=200},  //8
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3a00,.real_power=200},  //9
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3e00,.real_power=200},  //10
                                    {.u8_centralGain=0x12,.u16_regPwr=0x4100,.real_power=200},  //11
                                    {.u8_centralGain=0x12,.u16_regPwr=0x4400,.real_power=200},  //12
                                    {.u8_centralGain=0x12,.u16_regPwr=0x4700,.real_power=200},  //13
                                    {.u8_centralGain=0x12,.u16_regPwr=0x4b00,.real_power=200},  //14
                                    {.u8_centralGain=0x12,.u16_regPwr=0x4f00,.real_power=150},  //15
                                    {.u8_centralGain=0x12,.u16_regPwr=0x5300,.real_power=158},  //16
                                    {.u8_centralGain=0x12,.u16_regPwr=0x5700,.real_power=200},  //17
                                    {.u8_centralGain=0x12,.u16_regPwr=0x5a00,.real_power=200},  //18
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x5e00,.real_power=200},  //19
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6100,.real_power=200},  //20
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6500,.real_power=200},  //21
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6a00,.real_power=200},  //22
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6e00,.real_power=200},  //23
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x7200,.real_power=200},  //24
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x7800,.real_power=200},  //25
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x7c00,.real_power=200},  //26
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x7f00,.real_power=200},  //27
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x8500,.real_power=200},  //28
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x8900,.real_power=200},  //29
                                    {.u8_centralGain=0x0a,.u16_regPwr=0xff00,.real_power=200}  ///30
                                    },
            .u16_5g_ref_frq = 5740,
            .st_5g_chPowerClose = { {.u8_centralGain=0x1a,.u16_regPwr=0x0900,.real_power=200},  //0dbm
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x0000,.real_power=200},  //1
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x0d00,.real_power=200},  //2
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1100,.real_power=200},  //3
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1500,.real_power=200},  //4
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1900,.real_power=200},  //5
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1d00,.real_power=200},  //6
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2000,.real_power=200},  //7
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2400,.real_power=200},  //8
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2600,.real_power=200},  //9
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2800,.real_power=200},  //10
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2b00,.real_power=200},  //11
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2e00,.real_power=200},  //12
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3100,.real_power=200},  //13
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3400,.real_power=200},  //14
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3600,.real_power=150},  //15
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3900,.real_power=158},  //16
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3d00,.real_power=200},  //17
                                    {.u8_centralGain=0x12,.u16_regPwr=0x4000,.real_power=200},  //18
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x4300,.real_power=200},  //19
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x4700,.real_power=200},  //20
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x4a00,.real_power=200},  //21
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x4d00,.real_power=200},  //22
        ...
        {
            .u16_2g_ref_frq = 2438,
            .st_2g_chPowerClose = { {.u8_centralGain=0x1a,.u16_regPwr=0x0000,.real_power=200},  //0dbm
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x0d00,.real_power=200},  //1
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2400,.real_power=200},  //2
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2600,.real_power=200},  //3
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2900,.real_power=200},  //4
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2C00,.real_power=200},  //5
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2f00,.real_power=200},  //6
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3200,.real_power=200},  //7
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3600,.real_power=200},  //8
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3a00,.real_power=200},  //9
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3d00,.real_power=200},  //10
                                    {.u8_centralGain=0x12,.u16_regPwr=0x4100,.real_power=200},  //11
                                    {.u8_centralGain=0x12,.u16_regPwr=0x4400,.real_power=200},  //12
                                    {.u8_centralGain=0x12,.u16_regPwr=0x4800,.real_power=200},  //13
                                    {.u8_centralGain=0x12,.u16_regPwr=0x4b00,.real_power=200},  //14
                                    {.u8_centralGain=0x12,.u16_regPwr=0x4f00,.real_power=150},  //15
                                    {.u8_centralGain=0x12,.u16_regPwr=0x5200,.real_power=158},  //16
                                    {.u8_centralGain=0x12,.u16_regPwr=0x5600,.real_power=200},  //17
                                    {.u8_centralGain=0x12,.u16_regPwr=0x5900,.real_power=200},  //18
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x5d00,.real_power=200},  //19
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6000,.real_power=200},  //20
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6400,.real_power=200},  //21
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6800,.real_power=200},  //22
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x6c00,.real_power=200},  //23
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x7100,.real_power=200},  //24
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x7500,.real_power=200},  //25
            ...
            .u16_5g_ref_frq = 5731,
            .st_5g_chPowerClose = { {.u8_centralGain=0x1a,.u16_regPwr=0x0000,.real_power=200},  //0dbm
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x0400,.real_power=200},  //1
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x0800,.real_power=200},  //2
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x0c00,.real_power=200},  //3
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1000,.real_power=200},  //4
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1400,.real_power=200},  //5
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1800,.real_power=200},  //6
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x1c00,.real_power=200},  //7
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2000,.real_power=200},  //8
                                    {.u8_centralGain=0x1a,.u16_regPwr=0x2200,.real_power=200},  //9
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2400,.real_power=200},  //10
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2800,.real_power=200},  //11
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2b00,.real_power=200},  //12
                                    {.u8_centralGain=0x12,.u16_regPwr=0x2e00,.real_power=200},  //13
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3100,.real_power=200},  //14
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3300,.real_power=150},  //15
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3600,.real_power=158},  //16
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3900,.real_power=200},  //17
                                    {.u8_centralGain=0x12,.u16_regPwr=0x3c00,.real_power=200},  //18
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x3f00,.real_power=200},  //19
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x4300,.real_power=200},  //20
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x4600,.real_power=200},  //21
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x4a00,.real_power=200},  //22
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x4d00,.real_power=200},  //23
                                    {.u8_centralGain=0x0a,.u16_regPwr=0x5100,.real_power=200},  //24
