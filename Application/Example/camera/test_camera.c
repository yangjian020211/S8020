...
{  
    uint32_t pixel_dowm,pixel_up,line_down,line_up;
 ...
 //   *((volatile uint32_t*)0xa0010000) = 0x01d40736;
    ...
    *((volatile uint32_t*)0xa0010010) = 0xf0006000;
    ...
    if (lock_flag==3)
    {
       pixel_dowm =  *((volatile uint32_t*)0xa00500e0);
       pixel_up =  *((volatile uint32_t*)0xa00500e4);
       line_down =  *((volatile uint32_t*)0xa00500e8);
       line_up =  *((volatile uint32_t*)0xa00500ec);
       
        
        if((pixel_dowm==0)&&(pixel_up==0xf)&&(line_down==0x38)&&(line_up==0x4))
            continue;
            else
            {
               if (lost_count<3)
