...
APPLICATION_DIR ?= $(TOP_DIR)/Application/C201sp
...
FUNCTION_DEFS += -DSTM32F746xx -DUSE_WINBOND_SPI_NOR_FLASH -DUSE_IT66021_EDID_CONFIG_BIN -DRF_8003X -DC201S_ZZ -DUSE_EXTERN_LNA
###############################################################################
