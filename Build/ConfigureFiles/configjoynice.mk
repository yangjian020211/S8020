...
APPLICATION_DIR ?= $(TOP_DIR)/Application/Joynice
...
export CHIP = AR8020
export BOOT = AR8020
export BOARD = Joynice

export USB_DEV_CLASS_HID_ENABLE = 1

FUNCTION_DEFS += -DSTM32F746xx -DUSE_WINBOND_SPI_NOR_FLASH -DUSE_IT66021_EDID_CONFIG_BIN -DRF_8003X -DUSE_EXTERN_LNA
