...
APPLICATION_DIR ?= $(TOP_DIR)/Application/AR8020TEST8003S
NORFLASH_WPT_SRC_C := $(TOP_DIR)/Application/ConfigData/norflash_WPTable_8MB.c
...
FUNCTION_DEFS += -DSTM32F746xx -DUSE_WINBOND_SPI_NOR_FLASH -DUSE_ADV7611_EDID_CONFIG_BIN -DRF_8003X -DUPGRADE_DUAL_APP_DESIGN_EN -DUSE_EXTERN_LNA
