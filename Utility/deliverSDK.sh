 ...
 do  
  ...
  then 
      getdir $dir_or_file
         ...
         make clean
         make all
         mv app.bin $AR8020SW/Output/$SDK_VERSION/$tmp/ground_sky_app.bin
         mv ar8020.bin $AR8020SW/Output/$SDK_VERSION/$tmp/ground_sky_ar8020.bin
         make clean
         cd $AR8020SW/Build/Project/AR8020
         rm -rf $AR8020SW/Output/$SDK_VERSION_TAR
         rm -rf $AR8020SW/Output/*.bin
         make clean
         rm -rf $AR8020SW/Output/AR8020SDK/Application/*
         cd $BUILD_DIR
     fi
 done
